...
methods.isBlockJustKeys = function() {
    return _isBlockKeys;
};

methods.isBlockInputKeys = function() {
    return Menu.Menu.IsShowInput() || _isBlockKeys;
};
...
methods.getLicName = function (lic) {
    ...
    switch (lic) {
        case 'a_lic':
            licName = 'Ліцензія категорії А';
            break;
        case 'b_lic':
            licName = 'Ліцензія категорії B';
            break;
        case 'c_lic':
            licName = 'Ліцензія категорії C';
            break;
        case 'air_lic':
            licName = 'Ліцензія на повітряний транспорт';
            break;
        case 'ship_lic':
            licName = 'Ліцензія на водний транспорт';
            break;
        case 'taxi_lic':
            licName = 'Ліцензія на перевезення пасажирів';
            break;
        case 'law_lic':
            licName = 'Ліцензія юриста';
            break;
        case 'gun_lic':
            licName = 'Ліцензія на зброю';
            break;
        case 'biz_lic':
            licName = 'Ліцензія на підприємництво';
            break;
        case 'fish_lic':
            licName = 'Дозвіл на рибальство';
            break;
        case 'med_lic':
...
methods.getRareName = function (proc) {
    ...
    if (proc <= 50) {
        return 'Неймовірно рідкісна';
    }
    if (proc <= 60) {
        return 'Дуже рідкісна';
    }
    if (proc <= 70) {
        return 'Рідкісна';
    }
